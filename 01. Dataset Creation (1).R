...
# Working directory
setwd('C:/Users/LaptopCheckout/Latest-News-Classifier/0. Latest News Classifier/01. Dataset Creation')

# Path definition of the news archives
path <- 'C:/Users/LaptopCheckout/Latest-News-Classifier/0. Latest News Classifier/00. Raw dataset/BBC/bbc-fulltext/bbc'
